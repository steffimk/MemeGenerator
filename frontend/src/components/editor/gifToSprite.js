 ...
 */
export const gifToSprite = async (gif, maxWidth, maxHeight, caption, posX, posY, isItalic, isBold, fontSize, fontColor, maxDuration,) => {
  let arrayBuffer;
  let error;
  let frames;
  ...
  frames.forEach((frame, i) => {
    ...
    dataCtx.font = italic + ' ' + bold + ' ' + fontSize + 'px sans-serif';
    dataCtx.fillStyle = fontColor;
    console.log("Position" + posX + " gg" + posY);
    dataCtx.fillText(caption, posX, posY);
